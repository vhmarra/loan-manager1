...
public class HttpInterceptor extends WebRequestHandlerInterceptorAdapter {
    ...
    public HttpInterceptor(WebRequestInterceptor requestInterceptor, AccessTokenRepository repository, LogProducer producer) {
    ...
    public WebMvcConfigurerAdapter adapter() {
        return new WebMvcConfigurerAdapter() {
            ...
            public void addInterceptors(InterceptorRegistry registry) {
                registry.addInterceptor(new HttpInterceptor(requestInterceptor, repository, producer))
                        .addPathPatterns("/**")
